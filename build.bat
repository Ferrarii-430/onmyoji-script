...
REM     4) src\resource\config.json 覆盖到 build\src\resource\config.json
REM     5) 将 build\ 内的文件压缩为 yys-script-[版本]-release.zip
REM ============================================================
...
if errorlevel 1 ( echo [错误] 复制 config.json 失败 & exit /b 1 )
