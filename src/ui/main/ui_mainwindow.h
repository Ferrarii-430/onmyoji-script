...
public:
    ...
    void setupUi(QWidget *mainwindow)
    {
        ...
        settingButton->setGeometry(QRect(450, 8, 80, 30));
        settingButton->setToolButtonStyle(Qt::ToolButtonStyle::ToolButtonTextOnly);
        systemConfigTips = new QLabel(mainwindow);
        systemConfigTips->setObjectName("systemConfigTips");
        systemConfigTips->setGeometry(QRect(207, 368, 128, 36));
        QFont font;
    ...
    void retranslateUi(QWidget *mainwindow)
    {
        ...
        programmeAddBtn->setText(QCoreApplication::translate("mainwindow", "\346\267\273\345\212\240", nullptr));
        programmeRemoveBtn->setText(QCoreApplication::translate("mainwindow", "\345\210\240\351\231\244", nullptr));
